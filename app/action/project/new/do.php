...
class _project_new_do extends PostScene
{
	...
	function task(MCWEB_InterfaceSceneOutputVars $access)
	{
		...
		$insert_param	= array(
			...
			'use_cost_manhour'		=> $this->_use_cost_manhour,
		...
		list($res,$insert_id)	= $this->obj_project->insertProject($insert_param);

		if($res)
		{
			MCWEB_Util::redirectAction("/project/new/complete?id={$insert_id}&type={$this->_type}");
		}
		else
		{
