...
* @access   public
*/
class soapclientAU extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclientAU($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false){
	...
	*/
	function getProxy(){
		...
		$r = rand();
		$evalStr = 'class soap_proxy_'.$r.' extends soapclientAU {
				'.$evalStr.'
			}';
